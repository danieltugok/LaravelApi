...
Route::middleware('auth:api')->group(function () {
    ...
    Route::post('/unit/{id}/addvehicle',  [UnitController::class, 'addVerhicle']);
    Route::post('/unit/{id}/addpet',  [UnitController::class, 'addPet']);
    Route::post('/unit/{id}/removeperson',  [UnitController::class, 'removePerson']);
    Route::post('/unit/{id}/removevehicle',  [UnitController::class, 'removeVerhicle']);
    ...
    Route::get('/reservations/{id}/disableddates',  [ReservationController::class, 'getDisabeldDates']);
